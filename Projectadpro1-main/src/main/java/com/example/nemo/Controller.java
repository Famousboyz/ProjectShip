...
public class Controller {
    ...
    private String passwordExtract;
    ...
    public void initialize() {
        ...
        extractButton.setOnAction(e -> {
            ...
            try {
                zipFile = new ZipFile(inputListView.getItems().get(0));
                System.out.println(zipFile.isEncrypted());
                if (zipFile.isEncrypted()) {
                    zipFile.removeFile(inputListView.getItems().get(0));
                    extractPassword();
                    passwordExtract = passwordField.getText();
                    if (!passwordExtract.isEmpty()) {
                        zipFile = new ZipFile(inputListView.getItems().get(0), passwordExtract.toCharArray());
    ...
    public void extractPassword() throws IOException {
